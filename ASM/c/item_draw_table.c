...
item_draw_table_entry_t item_draw_table[] = {
    ...
    [0xA0] = { draw_gi_xlu_with_flame,      { 0x060004D0 } }, // Deku Stick Upgrade w/ Rainbow Smoke Effect
    [0xA1] = { draw_gi_deku_nut_with_flame, { 0x06000E90 } }, // Deku Nut Upgrade w/ Rainbow Smoke Effect
